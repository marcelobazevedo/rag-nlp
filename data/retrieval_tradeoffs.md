...
- `dense` melhor que `hybrid`: 0 perguntas
- `hybrid` melhor que `sparse`: 8 perguntas
- `sparse` melhor que `hybrid`: 4 perguntas
...
- todos empatados: 5 perguntas

### k=10

- `hybrid` melhor que `dense`: 11 perguntas
- `dense` melhor que `hybrid`: 1 perguntas
- `hybrid` melhor que `sparse`: 9 perguntas
- `sparse` melhor que `hybrid`: 4 perguntas
- todos empatados: 2 perguntas
...
- `k=5`: Quais sanções administrativas podem ser aplicadas a responsáveis por infrações na Lei 14.133/2021? | dense=0.00, sparse=0.75, hybrid=0.50
- `k=10`: Quais sanções administrativas podem ser aplicadas a responsáveis por infrações na Lei 14.133/2021? | dense=0.00, sparse=1.00, hybrid=0.50
- `k=10`: Qual é o conteúdo e as conclusões do Parecer 8/2024 da AGU? | dense=0.67, sparse=0.00, hybrid=0.33
...
- `k=10`: O que o Parecer 10/2025 estabelece sobre a designação de gestores e fiscais de contratos? | dense=0.00, sparse=0.67, hybrid=0.33
...
- `k=5`: O que o Parecer 8/2025 trata sobre pagamento antecipado em contratos administrativos? | dense=0.00, sparse=0.67, hybrid=0.00
- `k=10`: O que o Parecer 8/2025 trata sobre pagamento antecipado em contratos administrativos? | dense=0.00, sparse=0.67, hybrid=0.33
- `k=3`: O que o Parecer 1/2023 estabelece sobre inexigibilidade de licitação para serviços técnicos especializados? | dense=0.00, sparse=0.33, hybrid=0.00

## Perguntas em que o hybrid superou algum modo isolado

- `k=3`: Quais as modalidades de licitação existentes segundo a Lei 14.133/2021? | dense=0.33, sparse=0.00, hybrid=0.33
- `k=5`: Quais as modalidades de licitação existentes segundo a Lei 14.133/2021? | dense=0.33, sparse=0.00, hybrid=0.67
...
- `k=10`: Quais são os casos de inexigibilidade de licitação previstos na Lei 14.133/2021? | dense=0.50, sparse=0.00, hybrid=0.50
- `k=10`: Quais documentos são obrigatórios no processo de contratação direta segundo a Lei 14.133/2021? | dense=0.00, sparse=0.00, hybrid=0.50
- `k=3`: O que a Lei 14.133/2021 estabelece sobre nulidade de licitação e seus efeitos jurídicos? | dense=0.00, sparse=0.00, hybrid=0.33
- `k=5`: O que a Lei 14.133/2021 estabelece sobre nulidade de licitação e seus efeitos jurídicos? | dense=0.33, sparse=0.33, hybrid=0.67
